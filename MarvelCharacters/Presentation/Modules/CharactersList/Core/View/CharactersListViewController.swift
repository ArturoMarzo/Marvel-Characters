...
class CharactersListViewController: UIViewController {
    ...
    private func registerNibs() {
        tableView.register(UINib(nibName: String(describing: CharacterTableViewCell.self), bundle: nil), forCellReuseIdentifier: CharacterTableViewCell.cellIdentifier())
        tableView.register(UINib(nibName: String(describing: LoadingTableViewCell.self), bundle: nil), forCellReuseIdentifier: LoadingTableViewCell.cellIdentifier())
    }
...
extension CharactersListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch indexPath.section {
        case CharactersListViewController.indexForCharactersSection:
            guard let viewModel = viewModel, indexPath.row < viewModel.characters.count else { return }
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        switch indexPath.section {
        case CharactersListViewController.indexForLoadingSection:
            if let cell = cell as? LoadingTableViewCell, cell.mode == .loading {
...
extension CharactersListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case CharactersListViewController.indexForCharactersSection:
            ...
            return cell
        case CharactersListViewController.indexForLoadingSection:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: LoadingTableViewCell.cellIdentifier(), for: indexPath) as? LoadingTableViewCell else { return UITableViewCell() }
            switch viewModel.charactersListViewModelMode {
            case .loading:
